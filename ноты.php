...
<body>
	<div id="glaw">
		...
		<div class="blok2">
			...
			<button class="button_note" name="button_note1"  onclick="window.location.href = 'нотыБД1.php'"> 
				<?php 
			...
			<button class="button_note" name="button_note2"  onclick="window.location.href = 'нотыБД2.php'"> 
				<?php 
				  $dbc = mysqli_connect('localhost', 'root' ,'', 'site');
				  $query = "SELECT COUNT(*) FROM `note`";
				  $count = mysqli_query($dbc, $query);
			...
			<button class="button_note" name="button_note3"  onclick="window.location.href = 'нотыБД3.php'"> 
				<?php 
				  $dbc = mysqli_connect('localhost', 'root' ,'', 'site');
				  $query = "SELECT COUNT(*) FROM `note`";
				  $count = mysqli_query($dbc, $query);
				  $c = mysqli_fetch_array($count);	
				  $query1 = "SELECT * FROM `note` WHERE note_id = $c[0]-2";
				  $data = mysqli_query($dbc, $query1);
				  $row = mysqli_fetch_row($data);
				  echo "<h3> $row[1] - $row[2]</h3>";	
				?>	
			...
			<button class="button_note" name="button_note4"  onclick="window.location.href = 'нотыБД4.php'"> 
				<?php 
				  $dbc = mysqli_connect('localhost', 'root' ,'', 'site');
				  $query = "SELECT COUNT(*) FROM `note`";
				  $count = mysqli_query($dbc, $query);
				  $c = mysqli_fetch_array($count);	
				  $query1 = "SELECT * FROM `note` WHERE note_id = $c[0]-3";
				  $data = mysqli_query($dbc, $query1);
				  $row = mysqli_fetch_row($data);
				  echo "<h3> $row[1] - $row[2]</h3>";	
				?>	
			...
			<button class="button_note" name="button_note5"  onclick="window.location.href = 'нотыБД5.php'"> 
				<?php 
				  $dbc = mysqli_connect('localhost', 'root' ,'', 'site');
				  $query = "SELECT COUNT(*) FROM `note`";
				  $count = mysqli_query($dbc, $query);
				  $c = mysqli_fetch_array($count);	
				  $query1 = "SELECT * FROM `note` WHERE note_id = $c[0]-4";
				  $data = mysqli_query($dbc, $query1);
				  $row = mysqli_fetch_row($data);
				  echo "<h3> $row[1] - $row[2]</h3>";	
				?>	
			...
			<button class="button_note" name="button_note6"  onclick="window.location.href = 'нотыБД6.php'"> 
				<?php 
				  $dbc = mysqli_connect('localhost', 'root' ,'', 'site');
				  $query = "SELECT COUNT(*) FROM `note`";
				  $count = mysqli_query($dbc, $query);
